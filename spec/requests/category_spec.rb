...
describe "custom titles" do
  it 'custom title for category' do
    @category = Factory(:category, :custom_title => "Это кастомный заголовок для категории каталога")
    visit category_path(@category)
    page.should have_selector("title", :text => @category.custom_title + " | giftb2b.ru")
  end
end
